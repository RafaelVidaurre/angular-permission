describe('module: Permission', function () {
  ...
  describe('param: only', function () {
    ...
    it('should go to state if permissions are resolved', function () {
      // GIVEN
      // WHEN
      $state.go('accepted');
      $rootScope.$apply();
    ...
    it('should pass state params', function () {
      // GIVEN
  ...
  describe('param: except', function () {
    ...
    describe('used as function/promise', function(){
      ...
      it('should not go to child state if parent state is unauthorized', function () {
        // GIVEN
        $stateProvider.state('denied.deniedChild', {});
