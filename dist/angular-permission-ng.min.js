...
<<<<<<< a82d3f556507caa20cb997291afeb1bdd12dd47b
!function () {
  "use strict";
  ...
  a.$inject = ["$rootScope", "$location", "TransitionProperties", "TransitionEvents", "Authorization", "PermissionMap"], angular.module("permission.ng", ["permission", "ngRoute"]).run(a)
}(), function () {
  "use strict";
  function a(a, b, c, d) {
    "ngInject";
